...
export class CaseTransformer extends Transformer implements ObjectToXmlTransformer {
    public item(object: Case) {
        ...
        if (!object.people[0].employmentStatus || !object.people[0].employmentStatus.length) {
            throw new PartnerLinkError("No Employment Status has been provided.", 406);
        }

        if (
            (!object.people[0].homeNumber || object.people[0].homeNumber.length <= 3) &&
            (!object.people[0].mobileNumber || object.people[0].mobileNumber.length <= 3)
        ) {
                ...
                CaseDetails: {
                    ...
                    EmploymentDetails: {
                        EmployerName: object.people[0].employerName ?
                            object.people[0].employerName : object.people[object.people.length - 1].employerName,
                        EmploymentStatus: object.people[0].employmentStatus ? object.people[0].employmentStatus :
                            object.people[object.people.length - 1].employmentStatus,
                        JobTitle: object.people[0].jobTitle ? object.people[0].jobTitle :
                    ...
                    PersonalDetails: {
                        ...
                        FirstName: object.people[0].firstName,
                        Gender: object.people[0].gender,
                        HomeTelephone: object.people[0].homeNumber.length > 2 ?
                            object.people[0].homeNumber : object.people[0].mobileNumber,
