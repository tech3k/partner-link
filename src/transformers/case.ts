      ...
      CreateFullCaseRequest: {
        CaseDetails: {
          ...
          PersonalDetails: {
            ...
            PartnerCity: object.people[1]
              ? object.people[1].addresses[0].town
              : null,
            PartnerCountryID: object.people.length > 1 ? 1 : null,
            PartnerCounty: object.people[1]
              ? object.people[1].addresses[0].county
              : null,
            PartnerDateOfBirth: object.people[1]
              ? object.people[1].dateOfBirth.format('YYYY-MM-DD')
              : null,
            PartnerEmail: object.people[1]
              ? object.people[1].emailAddress
              : null,
            PartnerFirstName: object.people[1]
              ? object.people[1].firstName
              : null,
            PartnerGender: object.people[1] ? object.people[1].gender : null,
            PartnerHomeTelephone: object.people[1]
              ? object.people[1].homeNumber
              : null,
            PartnerMaidenName: object.people[1]
              ? object.people[1].maidenName
              : null,
            PartnerMaritalStatus: object.people[1]
              ? object.people[1].maritalStatus
              : null,
            PartnerMiddleName: object.people[1]
              ? object.people[1].maidenName
              : null,
            PartnerMobile: object.people[1]
              ? object.people[1].mobileNumber
              : null,
          ...
          Properties: {
            PropertyRequest: (object.properties || []).map(item =>
              new PropertyTransformer().item(item),
            ),
          },
          Vehicles: {
            VehicleRequest: (object.vehicles || []).map(item =>
              new VehicleTransformer().item(item),
            ),
          },
        },
