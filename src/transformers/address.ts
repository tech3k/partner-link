...
export class CreditSearchAddressTransformer extends Transformer
  ...
  public item(object: CreditSearchAddress): string {
    if (
      object.houseNumber === undefined ||
      object.houseNumber === null ||
      object.houseNumber.length === 0
    ) {
      throw new PartnerLinkError(
        'House Number is missing from the address.',
        406,
      );
    }

    if (
      object.street === undefined ||
      object.street === null ||
    ...
    if (
      object.postalCode === undefined ||
      object.postalCode === null ||
      object.postalCode.length === 0
    ) {
      throw new PartnerLinkError('Postcode is missing from the address.', 406);
    }

    if (
      object.town === undefined ||
      object.town === null ||
      object.town.length === 0
    ) {
    ...
    const houseNumber = addressMatches[1];
    const streetName =
      addressMatches[2] !== undefined ? addressMatches[2] : object.street;
...
export class CreditSearchAddressResultTransformer extends Transformer
...
export class AddAddressTransformer extends Transformer
  implements ObjectToXmlTransformer {
  public item(object: CreditSearchAddressResult, index: number) {
    if (
      object.county === undefined ||
      object.county === null ||
      object.county.length === 0
    ) {
