import {ExpenditureTransformer, IncomeTransformer} from './income-expenditure';
...
describe('Expenditure Transformer', () => {
    it('should transform a single item', () => {
        expect(new ExpenditureTransformer().item({name: 'MORTGAGE', value: 30000} as Expenditure))
            .toEqual({
                Name: 'MORTGAGE',
                Value: '300',
            });
